...
public class GuiRecipeTypeUlt extends GuiElement
{
	...
	{
		return new Rectangle4i(guiWidth + 176 + xRes, guiHeight + 70+15, 26, 63);
	}
	...
	public void renderBackground(int xAxis, int yAxis, int guiWidth, int guiHeight)
	{
		...
		guiObj.drawTexturedRect(guiWidth + 176 + xRes, guiHeight + 70+15, 0, 0, 26, 63);

		TileEntityFactory factory = tileEntity;
		int displayInt = factory.getScaledRecipeProgress(15);

		guiObj.drawTexturedRect(guiWidth + 181 + xRes, guiHeight + 94+15, 26, 0, 10, displayInt);
	...
	public void preMouseClicked(int xAxis, int yAxis, int button)
	{
		if(button == 0)
		{
			if(xAxis >= 180 + xRes && xAxis <= 196 + xRes && yAxis >= 75+15 && yAxis <= 91+15)
			{
				offsetX(26);
			}
			else if(xAxis >= 180 + xRes && xAxis <= 196 + xRes && yAxis >= 112+15 && yAxis <= 128+15)
			{
				offsetX(26);
			}
		}
